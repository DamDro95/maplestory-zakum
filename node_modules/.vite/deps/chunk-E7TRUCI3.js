...
import {
  BaseTexture,
  Texture
} from "./chunk-7QKX5WU6.js";
import {
  EffectWrapper
} from "./chunk-HEXNUATA.js";
import {
  SmartArray
} from "./chunk-D7EWEVTQ.js";
import {
  SerializationHelper
} from "./chunk-MCL33GAW.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-XFEADKG4.js").then((module) => this._dumpTools = module);
    }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-4Z7FUHYR.js");
    const textures = [];
...
//# sourceMappingURL=chunk-E7TRUCI3.js.map
